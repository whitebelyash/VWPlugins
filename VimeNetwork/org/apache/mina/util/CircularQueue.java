...
public class CircularQueue extends AbstractList implements Queue, Serializable {
   ...
   public Object peek() {
      return this.isEmpty() ? null : this.items[this.first];
   }
   ...
   public int size() {
      if (this.full) {
         ...
         return this.last >= this.first ? this.last - this.first : this.last - this.first + this.capacity();
      }
   }
