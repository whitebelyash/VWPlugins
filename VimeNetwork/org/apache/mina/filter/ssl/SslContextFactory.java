      ...
      if (kmf == null) {
         ...
         if (algorithm != null) {
            if (this.keyManagerFactoryProvider == null) {
               ...
               kmf = KeyManagerFactory.getInstance(algorithm, this.keyManagerFactoryProvider);
            }
         }
      }
      ...
      if (tmf == null) {
         ...
         if (algorithm != null) {
            if (this.trustManagerFactoryProvider == null) {
               ...
               tmf = TrustManagerFactory.getInstance(algorithm, this.trustManagerFactoryProvider);
            }
         }
      }
