...
public class NMSEntityUtils {
   ...
   public static void safeRegisterCustomEntity(Class clazz, String name) {
      safeRegisterCustomEntity(clazz, clazz.getSuperclass(), name);
   }

   public static void safeRegisterCustomEntity(Class clazz, Class nmsClazz, String name) {
      try {
         int id = (Integer)((Map)EntityTypes_e.get((Object)null)).get(nmsClazz);
         Map<Integer, Class> d = (Map)EntityTypes_d.get((Object)null);
         EntityTypes_registerEntity.invoke((Object)null, clazz, name, id);
         d.put(id, nmsClazz);
      } catch (Exception e) {
   ...
   public static org.bukkit.entity.Entity spawn(Entity entity, Location loc) {
      entity.setLocation(loc.getX(), loc.getY(), loc.getZ(), loc.getYaw(), loc.getPitch());
      getNMSWorld(loc.getWorld()).addEntity(entity, SpawnReason.CUSTOM);
   ...
   public static void walkToLocation(EntityCreature entity, Location loc) {
      ...
      PathEntity pathEntity = entity.world.a(entity, MathHelper.floor(loc.getX()), (int)loc.getY(), MathHelper.floor(loc.getZ()), (float)getPathfindingRange(entity), true, false, false, true);
      entity.setPathEntity(pathEntity);
      navigation.a(pathEntity, (double)1.0F);
   }
   ...
   public static World getNMSWorld(org.bukkit.World bukkitWorld) {
